...
export default function ContractUpdateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setJobSubtype(cleanValues.jobSubtype);
    setEstDuration(cleanValues.estDuration);
    setPmFreq(cleanValues.pmFreq);
    setContractCharge(cleanValues.contractCharge);
    setStartDate(cleanValues.startDate);
    setExpiryDate(cleanValues.expiryDate);
    setBillingType(cleanValues.billingType);
    setPmActive(cleanValues.pmActive);
  ...
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(Contract, idProp)
        : contractModelProp;
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            Contract.copyOf(contractRecord, (updated) => {
