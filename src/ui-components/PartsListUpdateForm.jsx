...
export default function PartsListUpdateForm(props) {
  const {
    id: idProp,
    partsList: partsListModelProp,
    onSuccess,
    onError,
    onSubmit,
    onValidate,
  ...
  const resetStateValues = () => {
    const cleanValues = partsListRecord
      ? { ...initialValues, ...partsListRecord }
      : initialValues;
  ...
  const [partsListRecord, setPartsListRecord] =
    React.useState(partsListModelProp);
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(PartsList, idProp)
        : partsListModelProp;
      setPartsListRecord(record);
    };
    queryData();
  }, [idProp, partsListModelProp]);
  React.useEffect(resetStateValues, [partsListRecord]);
  const validations = {
    name: [],
    quantity: [],
    cost: [],
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            PartsList.copyOf(partsListRecord, (updated) => {
      ...
      {...getOverrideProps(overrides, "PartsListUpdateForm")}
      {...rest}
    >
      <TextField
        label="Name"
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || partsListModelProp)}
