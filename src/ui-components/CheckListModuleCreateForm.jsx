...
export default function CheckListModuleCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setVisibleOn(initialValues.visibleOn);
    setJobTypes(initialValues.JobTypes);
    setIsReq(initialValues.isReq);
    setConnectionId(initialValues.connectionId);
    setErrors({});
  };
  const validations = {
    name: [],
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new CheckListModule(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "CheckListModuleCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
