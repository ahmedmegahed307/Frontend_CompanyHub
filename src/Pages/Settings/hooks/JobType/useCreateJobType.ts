...
import { JobType,createJobType } from "../../../../services/JobTypeService/jobtype-service";

const useCreateJobType = (onCreate: () => void) => {
  const queryClient = useQueryClient();

  const createJobTypeMutation = useMutation<JobType, Error, JobType>(createJobType.post, {
