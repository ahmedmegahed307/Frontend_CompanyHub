...
import { JobSubType, JobSubTypeMutationAPI } from "../../../../services/JobSubTypesService/jobsubtype-service";

const useJobSubTypeMutation = (onUpdateOrDelete: () => void, isUpdate: boolean) => {
